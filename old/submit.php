...
<div id="templatemo_main_wrapper">
 ...
 <form name="frmsendmail" method="post" action="1.php" >
      <table width="100%"  border="0">
       
        <tr>
          <td align="left" class="text"><strong>From: </strong></td>
          <td><input name="Name" type="text" class="input" id="txtEmailfrm22" size="30" maxlength="100" placeholder="Your Name" data-theme="d"></td>
        </tr>
        <tr>
          <td align="left" class="text" required><strong>Category: </strong></td>
          <td>
		<select name="Category" required >
			<option>Select Category</option>
			<option value='Login'>Login Problems</option>
			<option value='ServiceBook'>Service Book Queries</option>
			<option value='Modules'>Module Clarification</option>
			<option value='Miscellaneous'>Miscellaneous</option>
		</select>
	  </td>
        </tr>
        <tr>
          <td align="left" class="text"><strong>Topic: </strong></td>
        <td><input name="Topic" type="text" class="input" id="txtSub22" size="30" maxlength="100"  placeholder="Give a meaningful heading" data-theme="d"></td>
        </tr>
        <tr>
          <td align="left" valign="top" class="text"><strong>Query in Detail: </strong></td>
         <td><textarea name="Txt" cols="50" rows="10" class="input" id="textarea"  placeholder="Description" data-theme="d"></textarea><br><br>
		<br><br></td>
        </tr>
      <tr>
          <td align="left" colspan=2><input name="hidSubmit" type="hidden" id="hidSubmit" value="true">
              <input name="Submit" type="submit" class="input" value="Submit" data-inline="true">
          <input name="Submit2" type="reset" class="input" value="Reset" data-inline="true">
		  <a href="blog.php" rel="external"><input name="back" type="button" value="Back" data-inline="true"></a></td>
        </tr>         
      </table>
     </form>             
